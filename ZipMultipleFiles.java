...
public class ZipMultipleFiles {
    ...
    public static void create(List<String> sourceFileNames, String destinationFileName) throws IOException {
        try (ZipOutputStream zipOut = new ZipOutputStream(new FileOutputStream("C:/Users/saitu/Downloads/Java_Practice/testing.zip"))) {
    ...
    public static void main(String[] args) throws IOException {
        URL urlOne = ZipAFile.class.getResource("cat1.jpeg");
        URL urlTwo = ZipAFile.class.getResource("cat2.jpeg");
